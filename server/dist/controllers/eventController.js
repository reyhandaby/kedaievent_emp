...
exports.deleteEvent = exports.registerForEvent = exports.getEventById = exports.getAllEvents = exports.createEvent = void 0;
...
const createEvent = async (req, res) => {
    try {
        ...
        console.log("[CreateEvent] Incoming payload:", {
            title,
            descriptionLength: description === null || description === void 0 ? void 0 : description.length,
        ...
        console.error("[CreateEvent] Failed to create event:", err === null || err === void 0 ? void 0 : err.message);
...
const registerForEvent = async (req, res) => {
    ...
    try {
        const { id } = req.params;
        const { userId, pointsToUse = 0, voucherCode } = req.body;
        ...
        const createdTransaction = await prisma.$transaction(async (tx) => {
            ...
            const transaction = await tx.transaction.create({
                data: {
                    ...
                    voucherId: (_a = voucher === null || voucher === void 0 ? void 0 : voucher.id) !== null && _a !== void 0 ? _a : null,
        ...
        console.log('[RegisterEvent] Registration successful:', { eventId: eventIdNum, userId: userIdNum, totalPrice, pointsUsed: safePointsToUse, voucherId: (_a = voucher === null || voucher === void 0 ? void 0 : voucher.id) !== null && _a !== void 0 ? _a : null });
        return res.status(201).json({ message: 'Registered for event successfully', transaction: createdTransaction });
    }
    catch (err) {
        console.error('[RegisterEvent] Error:', err === null || err === void 0 ? void 0 : err.message);
...
const deleteEvent = async (req, res) => {
    ...
    try {
        ...
        const force = (((_a = req.query) === null || _a === void 0 ? void 0 : _a.force) === 'true');
        if (force) {
